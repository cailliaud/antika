...
ALTER TABLE ENGENDRE ADD CONSTRAINT FK_ENGENDRE1 FOREIGN KEY (ID_RACE)
      REFERENCES RACE (ID_RACE) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE ENGENDRE ADD CONSTRAINT FK_ENGENDRE2 FOREIGN KEY (ID_DIEU)
